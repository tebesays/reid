        ...
        <nav class="navbar navbar-default container">
            ...
            <div class="collapse navbar-collapse" id="collapse">
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown"><a href="index.php"> Beranda</a>
                    </li>
                    <li class="active"><a href="choose.php"> Buat Tulisan</a>               
                    </li>
                    <li class="dropdown"><a href="products.php"> Bacaan</a>               
                    </li>
                    <li class="dropdown"><a href="testimoni.php"> Testimonials</a>
                    </li>
...
<ul class="dropdown-menu" role="menu">
    ...
    <div class="container">
        ...
        <h3 class="text-primary">Buat Tulisan</h3>
            ...
            <form method="post" action='' enctype="multipart/form-data">
                ...
                <div class="form-group">
                                    <input type="file" class="form-control" value="Thumbnail" name="atc" accept="image/*">
                </div>
                                <LABEL>Bacaan</LABEL>
                                <div class="form-group">
                    <label class="sr-only">Book</label>
                                    <input type="file" class="form-control" value="Bacaan" name="atc2" accept=".pdf">
                </div>
                <div class="form-group">
                    <label class="sr-only"></label>
    ...
    mkdir("book", 0777);
    umask($oldmask1);
    $fileatc2 = "book/$atc2_name";
    copy($atc2, $fileatc2);
    //----------------------Finish Uploud----------------------

    $sql2 = mysqli_query($conn, "INSERT INTO book VALUES(DEFAULT,'$desk','Haikal Naufal','$judul','$fileatc2','$fileatc','$kategori','$depsing','$umur')");

            if ($sql2) 
            {
                            echo"<script language='javascript'>window.alert('$fileatc2 $fileatc done');
            window.location='form.php'</script>";
            }
            else
            {
                            echo"<script language='javascript'>window.alert('$fileatc2 $fileatc failed');
            window.location='form.php'</script>";
            }
            }
            ?>
